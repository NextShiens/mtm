...
import { View, StyleSheet, TouchableOpacity, Text,ToastAndroid, Image } from 'react-native';
...
const EducationPage = () => {
  ...
  const handleSave = async () => {
   ...
   const occupationOptions= ['Service', 'Business', 'Retired', 'Not Employed' ,  'Account Director',
      'Accountant',
      'Advocate',
      'AGM',
      'Analyst',
    ...
    const incomeOptions= ['50,000', '2,50,000', '4,50,000', '6,50,000', '8,50,000', '10,50,000',
