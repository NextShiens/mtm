...
import { ScrollView, RefreshControl, TouchableOpacity, View, Text, Image } from 'react-native';
...
const SavedUserScreen = ({ navigation }) => {
  ...
  const onRefresh = useCallback(() => {
    setRefreshing(true);
    fetchSavedUsers().then(() => setRefreshing(false));
  }, []);
