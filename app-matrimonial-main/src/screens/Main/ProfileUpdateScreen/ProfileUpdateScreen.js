...
const demoData = {
  ...
  AnnualIncome: [ '50,000', '2,50,000', '4,50,000', '6,50,000', '8,50,000', '10,50,000',
...
const ProfileUpdateScreen = ({ navigation }) => {
 ...
 {selectedBtn == 3 && (
  <View style={[STYLES.pH(HORIZON_MARGIN)]}>
    ...
    <Space mT={10} />
    <CustomDropdown
      data={demoData.AnnualIncome}
      field={'annualIncome'}
      defaultOption={profileData.annualIncome}
      setSelected={val => {
        onTextEnter('annualIncome', val);
      }}
