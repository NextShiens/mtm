...
export const IMAGES = {
  ...
  Payment:require('./cash-payment.png'),
  Settings:require('./settings.png'),
  Privacy:require('./privacy-policy.png'),
  Bell:require('./bell.png'),
  Sendd:require('./sendd.png'),
  Chat:require('./chat-bubble.png'),
  Sucess:require('./complete-task.png'),
  Save:require('./Saved2.png'),
};
